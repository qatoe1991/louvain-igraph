...
class SBMVertexPartition(MutableVertexPartition):
  """ Implements (asymptotic) Map.
  ...
  def __init__(self, graph, initial_membership=None, weights=None, node_sizes=None):
    ...
    super(SBMVertexPartition, self).__init__(graph, initial_membership)
    ...
    self._partition = _c_louvain._new_SBMVertexPartition(pygraph_t,
        initial_membership, weights)
    self._update_internal_membership()

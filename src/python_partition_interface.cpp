...
extern "C"
{
  ...
  PyObject* _new_MapVertexPartition(PyObject *self, PyObject *args, PyObject *keywds)
  {
    ...
    try
    {
      ...
      MapVertexPartition* partition = NULL;
      ...
      if (py_initial_membership != NULL && py_initial_membership != Py_None)
      {
        ...
        partition = new MapVertexPartition(graph, initial_membership);
      }
      else
        partition = new MapVertexPartition(graph);
  ...
  PyObject* _new_SBMVertexPartition(PyObject *self, PyObject *args, PyObject *keywds)
  {
    PyObject* py_obj_graph = NULL;
    PyObject* py_initial_membership = NULL;
    PyObject* py_weights = NULL;
    ...
    try
    {
      ...
      SBMVertexPartition* partition = NULL;
      ...
      if (py_initial_membership != NULL && py_initial_membership != Py_None)
      {
        ...
        partition = new SBMVertexPartition(graph, initial_membership);
      }
      else
        partition = new SBMVertexPartition(graph);
